...
# 파일 불러오기
y_6300 = pd.read_parquet('6300_y_24_01/24_01_01_6300_6350.parquet', columns=['WAFER_ID', 'GBIR_AFS2'])
y_6900 = pd.read_parquet('6900_24_01/24_01_01_6900_6950.parquet', columns=['WAFER_ID', 'GBIR_AFS2'])
x_6300 = pd.read_parquet('24_01_x/24_01_01_6100_DSP.parquet')
A = pd.read_csv('GBIR_20240110_A동_Sheet1.csv', usecols=['WAF_ID'])
B = pd.read_csv('GBIR_20240110_B동_Sheet1.csv', usecols=['WAF_ID'])
